...
class BooksApp extends React.Component {
    ...
    onShelfChange = (book, shelf) => {
        if (this.state.shelfs.indexOf(shelf) >= 0)
    ...
    componentDidMount() {
        ...
        /*
        BooksAPI.getAllShelfs()
            .then(availableShelfs => this.setState({ availableShelfs }))
            .then(() => (window.shelfsArr = this.state.shelfs)); //comment later
            */
    }
